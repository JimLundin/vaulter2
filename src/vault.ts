...
const CONVENTIONS = [
  ...
  "## External references",
  "",
  "This vault has web access (WebSearch / WebFetch). For notes about real-world",
  "things with a canonical public page — games, media, tools, places, public",
  "figures — look up an authoritative link (Wikipedia first, then an official or",
  "domain-appropriate site) and record it. Verify the page is the right subject;",
  "never recall or guess a URL. Skip private/personal entities and abstract",
  "concepts unless a source genuinely adds value.",
  "",
  "- If the subject has its own note, list links under a `## References` section",
  "  (just above `## See also`); a note may hold several.",
  "- If there is no dedicated note, add the link inline next to the mention,",
  "  e.g. `[Hollow Knight](https://en.wikipedia.org/wiki/Hollow_Knight)`.",
  "- Use Markdown links `[label](url)` for external URLs; keep `[[wikilinks]]`",
  "  for internal notes. Never write an external URL as a wikilink.",
  "",
  "## Maps of Content",
  "",
